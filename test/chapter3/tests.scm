...
(require schemeunit "../../src/chapter3/functions.scm")
...
;        -> Devuelve una lista compuesta por la primera S-expression de cada una de las listas internas que componen la
;           lista proporcionada, si las hubiere

; seconds
(check-equal? (seconds '((a b) (c d) (e f))) '(b d f))
;; seconds -> Acepta una lista vacía o compuesta únicamente de listas
;          -> Devuelve una lista compuesta por la segunda S-expression de cada una de las listas internas que componen la
;             lista proporcionada, si las hubiere
